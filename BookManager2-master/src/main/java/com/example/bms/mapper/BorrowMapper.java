...
public interface BorrowMapper {
    ...
    List<Map<String, Object>> selectWeeklyStats(@Param("startDate") String startDate, @Param("endDate") String endDate);

    int countCurrentBorrows(@Param("userid") Integer userid);
}