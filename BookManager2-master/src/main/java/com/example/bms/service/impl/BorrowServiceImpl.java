...
public class BorrowServiceImpl implements BorrowService {
    ...
    public List<Borrow> searchBorrowsByPage(Map<String, Object> params) {
        ...
        for(Borrow borrow : borrows) {
            ...
            if(borrow.getDuetime() != null) borrow.setDuetimestr(simpleDateFormat.format(borrow.getDuetime()));
        }
        return borrows;
    }
    ...
    public List<Map<String, Object>> getWeeklyStats() {
        return borrowMapper.selectWeeklyStats(null, null);
    }

    @Override
    public int countCurrentBorrows(Integer userid) {
